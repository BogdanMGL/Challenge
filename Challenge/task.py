...
def get_agencies():
    ...
    list_name = browser.get_webelements("xpath://html/body/main/div[1]/div/div/div[3]/div/div/div/div/div/div/div/div/div/div/div/div/div/div/div/div[1]/div/div[2]/div/div/div/div/div/div/div/div/div/a/span[1]")
    list_spending = browser.get_webelements("xpath://html/body/main/div[1]/div/div/div[3]/div/div/div/div/div/div/div/div/div/div/div/div/div/div/div/div[1]/div/div[2]/div/div/div/div/div/div/div/div/div/a/span[2]")
    list_agencies = []
    for i in range(len(list_name)): 
        list_agencies.append({"name":list_name[i].text,"spending":list_spending[i].text})
...
def get_individual_investments():
    ...
    browser.select_from_list_by_value("xpath://html/body/main/div/div/div/div[4]/div/div/div/div[2]/div/div[1]/div/div/div/div/div[2]/div[2]/div/label/select","-1")
    browser.wait_until_page_contains_element("xpath://html/body/main/div/div/div/div[4]/div/div/div/div[2]/div/div[1]/div/div/div/div/div[3]/div[2]/table/tbody/tr",limit = 158  ,timeout="20" )
    link_list = []
...
def individual_investments_to_the_table(individual_investments):
    ...
    excel.append_rows_to_worksheet(individual_investments, "Individual Investments")
    excel.save_workbook()
...
def downloads_file(link_list):
    ...
    for i in range(len(link_list)):
        ...
        browser.click_link("xpath://html/body/main/div/div/div/div[1]/div/div/div/div/div[1]/div/div/div/div/div[6]/a")
        path = os.path.abspath(os.curdir) + "/output/" + link_list[i]["file_name"] + ".pdf"
        try:
